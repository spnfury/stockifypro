    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl p-8 max-w-md w-full relative">
        ...
        <p className="text-gray-600 mb-4">
          Descubre cómo nuestro CRM especializado en ecommerce puede transformar tu negocio con automatización de envíos, gestión de pedidos y análisis de estadísticas en tiempo real.
        </p>
        <form 
          ref={formRef}
  ...
  return (
    <AuthProvider>
      <div className="min-h-screen bg-white text-black">
        <Head
          title="Stockify.pro | CRM para tiendas online - Gestión de pedidos ecommerce"
          description="Plataforma integral de CRM especializado en ecommerce con pago contra reembolso. Automatización de envíos, creación de etiquetas de envío, confirmación de pedidos y análisis de estadísticas de ventas en tiempo real."
          keywords="CRM para tiendas online, gestión de pedidos ecommerce, automatización de envíos, etiquetas de envío, confirmación de pedidos, estadísticas de ventas, integración con Shopify, gestión de contra reembolso, software para automatizar envíos en tiendas online, CRM especializado en ecommerce con pago contra reembolso, herramienta para crear etiquetas de envío automáticamente, sistema para confirmar pedidos y validar direcciones, plataforma para analizar estadísticas de ventas en tiempo real, integración sencilla de CRM con Shopify, gestión eficiente de pedidos y devoluciones en ecommerce"
          ogTitle="Stockify.pro | CRM para tiendas online"
          ogDescription="La solución más completa para la gestión de tu eCommerce. Automatiza envíos, gestiona pedidos y analiza estadísticas en tiempo real."
        />
        {/* Navigation */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center">
                    ...
                    <h1 className="text-5xl font-bold text-[#0F172A] mb-6">
                      CRM para tiendas online<br />Gestión de pedidos ecommerce
                    </h1>
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                      Plataforma integral de CRM especializado en ecommerce con pago contra reembolso. Automatización de envíos, creación de etiquetas de envío, confirmación de pedidos y análisis de estadísticas de ventas en tiempo real. 100% personalizable según las necesidades específicas de tu negocio.
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
                      Todo lo que Necesitas para Gestionar tu eCommerce
                    </h2>
                    <p className="text-xl text-gray-600">
                      La solución más completa para la gestión de pedidos ecommerce, automatización de envíos y análisis de estadísticas. Totalmente adaptable a tus procesos y flujos de trabajo.
                    </p>
                  </div>
